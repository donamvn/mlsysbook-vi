...
| **Dữ liệu $\cap$ Thuật toán $\cap$ Máy** | Kỹ thuật Hệ thống ML | Iron law, Roofline, các vòng lặp huấn luyện, phục vụ (serving) | @sec-huấn luyện mô hình, @sec-phục vụ (serving) mô hình, @sec-benchmarking |
