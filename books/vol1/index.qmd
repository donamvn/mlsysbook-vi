...
<p id="learning-path" class="unnumbered" style="font-size: 1.45rem; font-weight: 600; line-height: 1.25; margin: 1.5rem 0 0.75rem;">Lộ trình học</p>

Cuốn sách đi qua bốn giai đoạn:

- **Phần I: Nền tảng**: Thiết lập nền tảng khái niệm và mô hình tư duy làm cơ sở cho công việc hệ thống hiệu quả.
- **Phần II: Xây dựng**: Thiết kế các luồng công việc hoàn chỉnh, từ pipeline dữ liệu đến hạ tầng huấn luyện.
- **Phần III: Tối ưu hóa**: Biến hiểu biết lý thuyết thành các hệ thống chạy hiệu quả trong môi trường hạn chế tài nguyên.
- **Phần IV: Triển khai**: Xử lý phục vụ (serving), vận hành và các thực hành kỹ thuật có trách nhiệm.
...
- **Thành thạo lập trình** Python và quen thuộc với NumPy
...
<p id="listen-to-the-machine-learning-systems-podcast" class="unnumbered" style="font-size: 1.45rem; font-weight: 600; line-height: 1.25; margin: 1.5rem 0 0.75rem;">Nghe podcast Machine Learning Systems</p>
...
Đây là một dự án hợp tác. Hướng dẫn đóng góp của dự án giải thích cách tham gia, và mọi phản hồi, sửa lỗi, ý tưởng mới đều được hoan nghênh thông qua hệ thống theo dõi issue trên GitHub tại kho lưu trữ của sách (`harvard-edge/cs249r_book`).
:::
